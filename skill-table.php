    ...
    <div class="d-flex">
        ...
        <div class="container-fluid p-2">
            ...
            <table class="table table-dark table-striped table-bordered table-hover text-center">
                ...
                <tr class="bg-info">
                    <th colspan="6">
                        <a href="add-skill.php" class="btn text-light bg-success btn-md float-left">
                            Add <i class="fas fa-plus-circle"></i>
                        </a>
                    </th>

                    <h4 class="text-center bg-success p-3">Skill Details</h4>
                </tr>
               ...
               <td>" . ((strlen($row['Description']) > 50) ? substr($row['Description'], 0, 50) . '...' : $row['Description']) . "</td> 
                ...
                <td>
                  <a href='edit-skill.php?id=" . $row['ID'] . "' class='btn btn-secondary bg-primary'>
                  <i class='fas fa-edit'></i>
                  </a>
                </td>

                <td>
                    <a href='delete-skill.php?id=" . $row['ID'] . "' 
